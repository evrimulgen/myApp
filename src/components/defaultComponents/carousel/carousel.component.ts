...
@Component({
    ...
    <div (mouseenter)="pause()" (mouseleave)="play()" class="carousel slide">
      <ol *ngIf="isIndicator" class="carousel-indicators" [hidden]="slides.length <= 1">
...
export class Carousel {
  ...
  @Input() public noPause: boolean;
    @Input() public isIndicator: boolean;
...
/***
Use below code for carousel
<carousel [interval]="NextPhotoInterval" [noWrap]="noLoopSlides" [isIndicator]="showIndicator">
